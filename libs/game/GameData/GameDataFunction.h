...
public:
    ...
    static s32 getScenarioNo(al::LayoutActor const*);
    ...
    static void tryGetNextMainScenarioLabel(sead::BufferedSafeStringBase<char> *,sead::BufferedSafeStringBase<char> *,al::IUseSceneObjHolder const*);
    ...
    static void tryFindExistCoinCollectStagePosExcludeHomeStageInCurrentWorld(sead::Vector3<float> *,char const**,GameDataHolderAccessor);
    ...
    static void makeTextureSaveDataFileName(sead::BufferedSafeStringBase<char> *,nn::g3d::ResFile const*,GameDataHolder const*,int);
